...
/**
 * Created by MickelPickel on 2017-04-13.
 */

public class CircleAttacker extends Attackers {
    ...
    public CircleAttacker(World world, AssetManagerClass assetManagerClass) {
...
//        Gdx.app.log("Default x "+ Curvy_Ball.camera.position.x," <--");
    ...
    //dont for get to set a dispose method for deleting the object when the object move off screen
}
